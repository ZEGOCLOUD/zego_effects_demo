...
- (instancetype)initWithPixelFormatType:(OSType)pixelFormatType {
    ...
    if (self) {
        ...
        _sampleBufferCallbackQueue = dispatch_queue_create("im.zego.ZGCaptureDeviceCamera.outputCallbackQueue", DISPATCH_QUEUE_SERIAL);
    }
    return self;
}
...
- (void)switchCameraPosition {
    ...
    NSLog(@"📷 🔄 macOS does not support switching front/back camera");
